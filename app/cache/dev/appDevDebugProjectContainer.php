...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'UEO', 'host' => '127.0.0.1', 'port' => '3306', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e->addDriver($d, 'UEO\\ChoixBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('UEOChoixBundle' => 'UEO\\ChoixBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/Users/WebDevEur/Google Drive/0. Projet Thématique/70. Codes/UEOptionnelles/app/cache/dev/doctrine/orm/Proxies');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.ruby.bin' => '/Users/WebDevEur/.rvm/rubies/ruby-1.9.3-p194/bin/ruby',
