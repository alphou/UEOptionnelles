 ...
 */
class Choix extends \UEO\ChoixBundle\Entity\Choix implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'dateChoix', 'etudiant', 'module');
        }
    ...
    public function setDateChoix($dateChoix)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateChoix', array($dateChoix));

        return parent::setDateChoix($dateChoix);
    }
    ...
    public function getDateChoix()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDateChoix', array());

        return parent::getDateChoix();
    }
